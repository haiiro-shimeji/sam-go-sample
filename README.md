...
This is a sample template for sam-go-sample - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name sam-go-sample --query 'Stacks[].Outputs'
```
